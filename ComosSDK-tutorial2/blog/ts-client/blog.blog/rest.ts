...
export interface BlogQueryListPostResponse {
  post?: BlogPost[];
...
export interface BlogQueryShowPostResponse {
  post?: BlogPost;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryListPost
   * @summary Queries a list of ListPost items.
  ...
  queryListPost = (
    ...
    this.request<BlogQueryListPostResponse, RpcStatus>({
   ...
   * @tags Query
   * @name QueryShowPost
   * @summary Queries a list of ShowPost items.
   * @request GET:/blog/blog/show_post/{id}
   */
  queryShowPost = (id: string, params: RequestParams = {}) =>
    this.request<BlogQueryShowPostResponse, RpcStatus>({
